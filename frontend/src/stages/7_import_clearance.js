...
class ImportClearance extends Component {
  ...
  onSubmit = async (event) => {
    ...
    try{
      ...
      this.uploadFileToAzure(this.state.releaseOrderDocs, this.state.releaseOrderDocsHash);
  ...
  render() {
    ...
    return (
      <div>
      <b>Contract State:</b> Import Clearance<br/>

      <Modal trigger={<Button primary>Upload Release Docs</Button>}>
              ...
              <Form.Field>
                ...
                {this.state.releaseOrderDocsHash &&
                  <div>
                    ...
                    Upload Progress: {this.state.releaseOrderDocsProgress}%  
                </div>
                }
              </Form.Field>
        ...
        <Modal size={'mini'} trigger={<Button primary>Reject Docs</Button>}>
