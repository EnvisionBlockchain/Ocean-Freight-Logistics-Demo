...
class RecoverOrder extends Component {
  ...
  onSubmit = async (event) => {
    ...
    try{
      ...
      this.uploadFileToAzure(this.state.deliveryOrderDocs, this.state.deliveryOrderDocsHash);
  ...
  render() {
    ...
    return (
      <div>
      <b>Contract State:</b> Recover Shipment<br/>

      <Modal trigger={<Button primary>Upload Delivery Docs</Button>}>
          <Modal.Header>Upload Delivery Order Document</Modal.Header>
          <Modal.Content>
              ...
              <Form.Field>
                ...
                {this.state.deliveryOrderDocsHash &&
                  <div>
                    ...
                    Upload Progress: {this.state.deliveryOrderDocsProgress}%  
                </div>
                }
              </Form.Field>
