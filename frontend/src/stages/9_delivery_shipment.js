...
class DeliveryOrder extends Component {
  ...
  render() {
    ...
    return (
      <div>
      <b>Contract State:</b> Shipment Delivery<br/>
        <Modal size={'small'} trigger={<Button primary>Send Delivery Order</Button>}>
          <Modal.Header>Send Delivery Order For Consignee Signature</Modal.Header>
          <Modal.Content>
            Send?
            <Button floated='right' color='green' loading={this.state.loading} primary basic onClick={this.sendDeliveryOrder}>Send</Button>
            {statusMessage}
          </Modal.Content>
        </Modal>
